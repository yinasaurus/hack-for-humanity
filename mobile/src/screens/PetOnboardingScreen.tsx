...
export function PetOnboardingScreen() {
  ...
  const finish = async () => {
    ...
    try { await setUser(await completeOnboarding(user.id, petType, petName.trim())); }
  ...
  return (
    <ScrollView contentContainerStyle={[styles.root, { paddingTop: insets.top + 28, paddingBottom: insets.bottom + 28 }]}>
      ...
      <Text style={styles.copy}>Pick the friend you’d like beside you. You can change their look later.</Text>
