...
export const WARDROBE_ITEMS: readonly WardrobeItem[] = [
  ...
  // Scenes are always available — backgrounds are not gated keepsakes.
  { field: 'scene', value: 'sky', unlockId: null },
  { field: 'scene', value: 'sunny_meadow', unlockId: null },
  { field: 'scene', value: 'cozy_nook', unlockId: null },
  { field: 'scene', value: 'quiet_garden', unlockId: null },
